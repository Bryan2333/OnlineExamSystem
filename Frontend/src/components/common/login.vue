  ...
  <div id="login">
    ...
    <el-row class="main-container">
      <el-col :lg="8" :xs="16" :md="10" :span="10">
        <div class="top">
          <i class="iconfont icon-kaoshi"></i><span class="title">Online exam system</span>
        </div>
        <div class="bottom">
          <div class="container">
            ...
            <el-form :label-position="labelPosition" label-width="80px" :model="formLabelAlign">
              <el-form-item label="Username">
                <el-input v-model.number="formLabelAlign.username" placeholder="Please enter a username"></el-input>
              </el-form-item>
...
export default {
  ...
  methods: {
    //用户登录请求后台处理
    login() {
      console.log("The login operation is executed-------");
      this.$axios({
        url: `/login`,
        method: 'post',
        data: {
