        ...
        <section class="append">
          <ul>
            <li>
              ...
              <el-select v-model="optionValue" placeholder="Please select a question type" class="w150">
                <el-option
            ...
            <li v-if="optionValue === '选择题'">
              <span>Chapters:  &nbsp </span>
              <el-input
                placeholder="Please enter the corresponding section"
            ...
            <li v-if="optionValue === '填空题'">
              <span>Difficulty level: &nbsp</span>
            ...
            <li v-if="optionValue === '判断题'">
              <span>Difficulty level: &nbsp</span>
              <el-select v-model="postJudge.level" placeholder="选择难度" class="w150">
                <el-option
                  v-for="item in levels"
                  :key="item.value"
                  :label="item.label"
            ...
            <li v-if="optionValue === '选择题'">
              <span>Answer:</span>
              <el-select v-model="postChange.rightAnswer" placeholder="选择正确选项" class="w150">
                <el-option
  ...
  methods: {
    ...
    changeSubmit() { //选择题题库提交
      ...
      this.$axios({ //提交数据到选择题题库表
        ...
        this.$axios('/selectionQuestionId').then(res => { //获取当前题目的questionId
