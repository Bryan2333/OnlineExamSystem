<template>
  <div class="score">
    <div class="title">
      ...
      <p class="description">(Score: 100,Limited time: 100min)</p>
      <p class="description">学生：张三</p>
    </div>
    <div class="total">
      <div class="look">
          Exam Result
      ...
      <div class="show">
        <div class="img1" :class="{'img1Transform': imgShow}">
          <img :src="imgSrc.fail1" alt="Crying" v-if="score < 60">
        ...
        <div class="img2" :class="{'img2Transform': imgShow}">
          <img :src="imgSrc.fail2" alt="Crying" v-if="score < 60">
