    ...
    <el-row class="padding-50">
      <el-col :span="24">
        <ul class="list">
          ...
          <li><a href="javascript:" @click="exam()">My Exam</a></li>
          <li><a href="javascript:" @click="practice()">My Practice</a></li>
          <li><router-link to="/scoreTable">My score</router-link></li>
          <li><router-link to="/message">Leave me a message</router-link></li>
          <li class="right" @mouseenter="flag = !flag" @mouseleave="flag = !flag">
            <a href="javascript:"><i class="iconfont icon-Userselect icon"></i>{{user.userName}}</a>
            <div class="msg" v-if="flag">
              <p @click="manage()">Settings</p>
              <p class="exit" @click="exit()">Quit</p>
            </div>
          </li>
        </ul>
      </el-col>
