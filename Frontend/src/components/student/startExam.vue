  ...
  <div id="myExam">
    ...
    <div class="wrapper">
      <ul class="top">
        ...
        <li class="search-li"><div class="icon"><input type="text" placeholder="Exam paper name" class="search" v-model="key"><i class="el-icon-search"></i></div></li>
      ...
      <ul class="paper" v-loading="loading">
        <li class="item" v-for="(item,index) in pagination.records" :key="index">
          ...
          <div class="info">
            ...
            <i class="iconfont icon-icon-time"></i><span v-if="item.totalTime != null">Time Limit: {{item.totalTime}}</span>
            <i class="iconfont icon-fenshu"></i><span>Out{{item.totalScore}}分</span>
          </div>
        </li>
      </ul>
